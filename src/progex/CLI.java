...
public class CLI {
	...
	public static void printHelp(String errMsg) {
		...
		String[] help = {
			...
			"EXAMPLES:\n",
			"   java -jar PROGEX.jar -cfg -lang java -format dot  /home/user/Example/src\n",
			...
			"   java -jar PROGEX.jar -outdir /home/user/outputs -format json -pdg  /home/user/example/src\n",
			...
			"     program is valid according to the compiler of that language. Analyzing ",
